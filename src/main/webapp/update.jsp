    ...
    <form action="update" method="post">
        ...
        <div class="form-group">
            ...
            <select name="birthplace" class="form-control">
                <option ${contact.birthplace == "广州"?"selected":""} value="广州">广州</option>
				<option ${contact.birthplace == "上海"?"selected":""} value="上海">上海</option>
                <option ${contact.birthplace == "北京"?"selected":""} value="北京">北京</option>
                <option ${contact.birthplace == "大连"?"selected":""} value="大连">大连</option>
